"""querychat query logger — local CSV backend (app-04a).
...
For the MongoDB version that works on Posit Connect: see app-04b-log-mongodb.py

Run: shiny run app-04a-log-local.py
Requires: GITHUB_TOKEN (or other LLM key) in .env
"""
...
_chat_client = ChatGithub(model="gpt-4.1-mini")
